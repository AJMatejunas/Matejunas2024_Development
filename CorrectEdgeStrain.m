function [disp,strain,accel]=func_GridEdgeCorrection(grid,pos...
...
if CorOpts.corStrain==true && CorOpts.corDisp==false
 ...
 %% Perform linear interpolation
  ...
  Tinterp=Ycords((end-1):(end-CorNum*pitch+1));
 %% record strains for bottom free edge 
   BottomstrainXY=strain.s(1,:,:);
   BottomtrainYY=strain.y(1,:,:);
