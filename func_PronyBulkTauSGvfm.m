function [SG_param,CostFunc]=func_PronyBulkTauSGvfm(strain,time,SG,...
...
%Change log:
   ...
   %2023/03/15: Added the ability to calculate time constant along with
                    %bulk modulus changed function name to 
                    %func_PronyBulkTauSGvfm from func_PronyBulkSGvfm
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %% Put exact Properties into form used by the cost function
            knownParam=[exactProps.Kinf,exactProps.Ginf,exactProps.nu,....
                SolveOpts.constnu,exactProps.Gi];
            ...
            identParam=fmincon(@(constParam)func_ViscoBulkTauCostSG(SG, ...
            ...
            CostFunc=func_ViscoBulkTauCostSG(SG,...
