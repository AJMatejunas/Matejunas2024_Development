function [disp,strain,strainRate] = func_smoothCalcStrain_AJM(globalOpts,pos,...
...
if smoothingOpts.spatialSmooth == true
    strain = func_calcStrainFromDisp(disp.sSmooth.x,disp.sSmooth.y,pos.xStep,pos.yStep);
else
    strain = func_calcStrainFromDisp(dispTemp,pos.xStep,pos.yStep);
end
