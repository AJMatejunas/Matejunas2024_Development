...
%Version History/change log:
   ...
   %V3 2023-07-02: Changed calculations of strain and acceleration to
        %func_SmoothCalcStrainV4 and func_smoothCalcAccelerationsV4 to
        %match SGIdentification_SmoothingEvaluationV19_NoisyShearOnly.m
