...
GuessFactor=0.85:.01:1.15;

E_guess=GuessFactor*MatProps.E_exact; %Elastic Modulus
G_guess=GuessFactor*MatProps.G_exact;%Shear Modulus
K_guess=GuessFactor*MatProps.K_exact;

tau_guess=GuessFactor*MatProps.tau_exact;
...
saveas(gcf,strcat(testdeg,'KGSGCF_mapZoomed'))
saveas(gcf,strcat(testdeg,'KGSGCF_mapZoomed.png'))
...
saveas(gcf,strcat(testdeg,'KGlogSGCF_mapZoomed'))
saveas(gcf,strcat(testdeg,'KGlogSGCF_mapZoomed.png'))
...
saveas(gcf,strcat(testdeg,'KtSGCF_mapZoomed'))
saveas(gcf,strcat(testdeg,'KtSGCF_mapZoomed.png'))
...
saveas(gcf,strcat(testdeg,'KtlogSGCF_mapZoomed'))
saveas(gcf,strcat(testdeg,'KtlogSGCF_mapZoomed.png'))
...
saveas(gcf,strcat(testdeg,'GtSGCF_mapZoomed'))
saveas(gcf,strcat(testdeg,'GtSGCF_mapZoomed.png'))
...
saveas(gcf,strcat(testdeg,'GtlogSGCF_mapZoomed'))
saveas(gcf,strcat(testdeg,'GtlogSGCF_mapZoomed.png'))
%% Save Cost Function
save(strcat(testdeg,'_KGphiSG_Zoomed.mat'),'phi_KG','phi_Gtau','phi_Ktau');
