...
%               10E-6];... tau1
    ...
    % (expected order of magnitudes of the constitutive parameters)
    SolveOpts.NormFactor=[1e9;... K1
        1e9;... G1
        1e-6]; %tau_1
...
%         disp.extrap.y = disp.y;
  ...
  %% Condition the data (censoring/downsampling/smoothing)
   ...
   %% Run the minimization
    ...
    [TempParam,TempPhi(ig)]=func_PronySGvfmV6(strain,time.vec,SG.x,SG.s,...
                        exactProps,...
